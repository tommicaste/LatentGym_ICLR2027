...
from skyrl_train.utils.trainer_utils import (
    calculate_multi_episode_metrics,
...
async def evaluate(
    ...
    # 4. Calculate Multi-Episode Metrics
    multi_eps_eval_metrics = calculate_multi_episode_metrics(
        concat_generator_outputs,
        concat_all_envs,
    )
    eval_metrics.update(multi_eps_eval_metrics)
