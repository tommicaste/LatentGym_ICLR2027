    ...
    def __init__(self, project_name, experiment_name, backends: Union[str, List[str]] = "console", config=None):
        ...
        if "wandb" in backends:
            ...
            wandb.init(
                ...
                group=config.trainer.wandb_group if config and "wandb_group" in config.trainer else None,
                entity=config.trainer.wandb_entity if config and "wandb_entity" in config.trainer else None,
                dir=config.trainer.wandb_dir if config and "wandb_dir" in config.trainer else None,
